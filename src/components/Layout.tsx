...
import {
  Home, Cpu, TrendingUp, Wallet, Terminal, Moon, Sun, Menu, X, BookOpen, LayoutGrid, MessageSquareText,
} from 'lucide-react';
...
const NAV = [
  ...
  { to: '/prompts', label: '提示词全览', desc: 'Prompt 工程', icon: MessageSquareText },
    ...
    <div className="min-h-screen">
      ...
      <header className="sticky top-0 z-40 bg-white/85 dark:bg-slate-950/85 backdrop-blur-md border-b border-slate-200 dark:border-slate-800">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 h-14 flex items-center gap-3">
          ...
          <a
            href="https://github.com/yw5579358/Vibe-Trading"
